...
- **Student_group** привязана к **program** и **curriculum**; у группы один план, но своя реализация (offering).
...
| student_group → curator_teacher | SET NULL |
| students.group_id → student_group | SET NULL |
...
- **V8** — student_group, students.group_id, group_leader

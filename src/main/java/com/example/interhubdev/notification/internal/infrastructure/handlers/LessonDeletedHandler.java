...
/**
 * Handler for schedule.lesson.deleted event.
 * <p>
...
@Slf4j
class LessonDeletedHandler implements OutboxEventHandler {

    private static final String EVENT_TYPE = "schedule.lesson.deleted";
